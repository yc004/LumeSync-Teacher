...
// Edit ../core/packages/engine/src/* instead.
(() => {
"use strict";
...
// ---- ../core/packages/engine/src/00-globals.js ----
// ========================================================
...
// ---- ../core/packages/engine/src/05-sync-classroom.js ----
// ========================================================
...
function SyncClassroom({
  ...
  }, isHost ? '🧑‍🏫 老师端 (主控)' : '👨‍🎓 学生端 (观看)'), isHost && /*#__PURE__*/React.createElement("button", {
  ...
  }))), !isHost && /*#__PURE__*/React.createElement(WindowControls, {
    forceFullscreen: settings.forceFullscreen
  }), isHost && /*#__PURE__*/React.createElement(WindowControls, null))), /*#__PURE__*/React.createElement("div", {
  ...
  })))), showChrome && isHost && showSettings && /*#__PURE__*/React.createElement(SettingsPanel, {
    settings: settings,
    onSettingsChange: onSettingsChange,
    socket: socketRef.current,
    onClose: () => setShowSettings(false),
    zIndex: "z-[9998]"
  }), showChrome && isHost && showClassroomView && /*#__PURE__*/React.createElement(ClassroomView, {
...
// ---- ../core/packages/engine/src/06-resource-loader.js ----
// ========================================================
// 资源调度工具函数
...
// ---- ../core/packages/engine/src/07-camera-manager.js ----
// ========================================================
...
// ---- ../core/packages/engine/src/components/WebPageSlide.js ----
...
// ---- ../core/packages/engine/src/components/SurveySlide.js ----
// ========================================================
// 问卷通用组件 - SurveySlide
// ========================================================
...
// ---- ../core/packages/engine/src/components/VoteSlide.js ----
// ========================================================
// 实时投票组件 - VoteSlide
// ========================================================
...
// ---- ../core/packages/engine/src/08-app.js ----
